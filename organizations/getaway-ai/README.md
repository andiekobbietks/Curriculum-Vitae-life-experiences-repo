...
```mermaid
gantt
    title My Journey at Getaway AI
    dateFormat  YYYY-MM-DD
    section Phases
    Product Research & Strategy    :2025-05-12, 30d
    UI/UX Design Development       :2025-05-19, 45d
    Architecture & Roadmap         :2025-05-15, 60d
    Prototype Development          :2025-06-03, 30d
```
